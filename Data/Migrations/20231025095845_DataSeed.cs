...
namespace Data.Migrations
{
    ...
    public partial class DataSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Hotels",
                columns: new[] { "HotelId", "AllInclusive", "CityId", "CompanyId", "ImageUrl", "Name", "RoomService", "Stars", "TotalRoom" },
                values: new object[,]
                {
                    { 1, true, 1, 1, "hotel-1.jpg", "Swiss Hotel", true, 5, 200 },
                    { 2, true, 1, 2, "hotel-2.jpg", "Hilton Hotel", true, 5, 200 },
                    { 3, true, 2, 3, "hotel-3.jpg", "Garden Hotel", true, 5, 200 },
                    { 4, true, 2, 4, "hotel-4.jpg", "Plaza Hotel", true, 5, 200 }
                });
